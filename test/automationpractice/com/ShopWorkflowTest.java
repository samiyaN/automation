...
public class ShopWorkflowTest {
	...
	public void continueToShoppingSummary() {
		...
		Assert.assertEquals(summary.getCartSummTotalProductsPrice().getText(), "$44.51");
		Assert.assertEquals(summary.getCartSummaryTotalPrice().getText(), "$46.51");
	...
	public void increaseQtyOfProduct1() {
		...
		Assert.assertEquals(summary.getCartSummTotalProductsPrice().getText(), "$64.38");
		Assert.assertEquals(summary.getCartSummaryTotalPrice().getText(), "$66.38");
		Assert.assertEquals(summary.getCartSummTotalShipping().getText(), "$2.00");
	}
	...
	public void billingAndDeliveryAddress() {
		Assert.assertEquals(summary.getCartSummBillingAdressName().getText(), "Samiya Nasir");
		Assert.assertEquals(summary.getCartSummBillingAdressOne().getText(), "Centar");
		Assert.assertEquals(summary.getCartSummBillingAdressCityState().getText(), "jhdch, Connecticut 12345");
		Assert.assertEquals(summary.getCartSummBillingAdressCountry().getText(), "United States");
		Assert.assertEquals(summary.getCartSummBillingAdressHomePhone().getText(), "12345");
		Assert.assertEquals(summary.getCartSummBillingAdressMobile().getText(), "12345");
	}
